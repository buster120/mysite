...
train_x,test_x,train_y,test_y=train_test_split(sentences,file_data.label.values,test_size=0.1,random_state=1)
all_data=sentences
...
def make_tensors(names,countries): #这里边得到的是有名字的列表，和国家对应的序号
